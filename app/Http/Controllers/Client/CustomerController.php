...
class CustomerController extends Controller
{
    public function index()
    {
        ...
        return view('client.customers.index', ['address'=>$address]);
    }
    ...
    public function get_address($location, $address=null)
    {
        ...
        return view('client.customers.address', ['obj'=>$obj, 'location'=>$location]);
    }
    ...
    public function save_address(Request $request)
    {
        ...
        $returnHTML = view('client.includes.address')->with('address', $address)->with('from', $data['location'])->render();
    ...
    public function addresses()
    {
        ...
        return view('client.customers.addresses', ['addresses'=>$addresses]);
    }
    ...
    public function add_delivery_instructions($address_id)
    {
        ...
        {
            return view('client.customers.delivery_instruction_form', ['obj'=>$obj]);
        }
    }
    ...
    {
        return view('client.customers.edit_profile');
    }
