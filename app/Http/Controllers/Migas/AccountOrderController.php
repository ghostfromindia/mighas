...
class AccountOrderController extends Controller
{
    public function index()
    {
        ...
        return view('hykon.orders.index', ['orders'=>$orders]);
    }
    ...
    public function order_details($order_id)
    {
    	...
    	if($order)
    	{
    		...
    		return view('hykon.orders.details', ['order'=>$order, 'order_status'=>$order_status, 'status'=>$status]);
    	}
    	else
    		abort('404');
    }
    ...
    public function cancel_order($order_id)
    {
        ...
        return view('hykon.orders.cancel_order', ['cancel_reasons'=>$cancel_reasons, 'order_id'=>$order_id]);
    }
    ...
    public function invoice($order_id){
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->loadView('hykon.pdf.invoice', compact('order','ordertotalinwords'));
        return $pdf->stream('invoice.pdf');
//        return view('hykon.pdf.invoice', compact('order','ordertotalinwords'));
    }
