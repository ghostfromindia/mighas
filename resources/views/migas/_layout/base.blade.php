...
<head>
    ...
    <!-- Title -->
    <title>Migas, the online portal</title>


    <!-- iDevices & Retina Favicons -->
    <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="{{asset('theme')}}/images/favicons/apple-touch-icon-72x72-precomposed.png" sizes="72x72" />
    <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="{{asset('theme')}}/images/favicons/apple-touch-icon-114x114-precomposed.png" sizes="114x114" />
    <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="{{asset('theme')}}/images/favicons/apple-touch-icon-144x144-precomposed.png" sizes="144x144" />
    <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="{{asset('theme')}}/images/favicons/apple-touch-icon-precomposed.png" />

    <!--  Desktop Favicons  -->
    <link rel="icon" type="image/png" href="{{asset('theme')}}/images/favicons/favicon-32x32.png" sizes="32x32">
    ...
    <link rel="stylesheet" href="{{asset('theme')}}/fonts/font-awesome/css/font-awesome.min.css" type="text/css" media="all">

    <!-- IOS Slider required css file -->
    <link rel="stylesheet" href="{{asset('theme')}}/css/sliders/ios/style.css" type="text/css" media="all">


    <!-- ***** Main + Responsive & Base sizing CSS Stylesheet ***** -->
    <link rel="stylesheet" href="{{asset('theme')}}/css/template.css" type="text/css" media="all">
    <link rel="stylesheet" href="{{asset('theme')}}/css/responsive.css" type="text/css" media="all">
    <link rel="stylesheet" href="{{asset('theme')}}/css/base-sizing.css" type="text/css" media="all">

    <!-- Required custom CSS file for this niche -->
    <link rel="stylesheet" href="{{asset('theme')}}/css/niches/custom-fashion.css" type="text/css" />

    <!-- Custom CSS Stylesheet (where you should add your own css rules) -->
    <link rel="stylesheet" href="{{asset('theme')}}/css/custom.css" type="text/css" />

    <!-- Modernizr Library -->
    <script type="text/javascript" src="{{asset('theme')}}/js/modernizr.min.js"></script>
    ...
    <style>
        ...
        .logo-container .logo-infocard .right-side {
            padding: 30px 35px;
            color: #ffffff;
            background: linear-gradient(45deg, #80953a, #60ae71);
        }
    </style>
</head>
                            ...
                            <div id="search" class="header-search align-self-center">
                                ...
                                <div class="search-container">
                                    <form id="searchform" class="header-searchform" action="https://www.google.com/search" method="get" target="_blank">
                                        <input id="q" name="q" maxlength="20" class="inputbox" type="text" size="20" value="SEARCH ..."
                        ...
                        <div class="site-header-main-left d-flex justify-content-start align-items-center">
                            ...
                            <div class="logo-container hasInfoCard logosize--yes">
                                ...
                                <h1 class="site-logo logo" id="logo">
                                    <a href="{{url('/')}}" title="">
                                        <img src="{{Key::get('site-logo-image')}}" class="logo-img" alt="Mighas" title="Mighas" />
                                    </a>
                                </h1>
                                <!--/ Logo -->
                                            ...
                                            <div class="col-sm-6 left-side d-flex">
                                                <div class="align-self-center">
                                                    <div class="infocard-wrapper text-center">
                                                        <img src="{{Key::get('site-logo-image')}}" class="mb-25" alt="Mighas" title="Mighas" />
                                                        <p>
                                                            {{Key::get('site-description')}}
                                                        </p>
                                                    </div>
                                                    <!--/ infocard-wrapper -->
                                                </div>
                            ...
                            <div class="main-menu-wrapper">
                                ...
                                <div id="main-menu" class="main-nav zn_mega_wrapper">
                                    <ul id="menu-main-menu" class="main-menu clearfix">
                                        ...
                                        <li>
                                            <a href="_5-fashion-product.html">PRODUCT</a>
                                        </li>
                                        <li>
                                                ...
                                                <ul class="cart_list product_list_widget ">
                                                    <li>
                                                        ...
                                                        <a href="#" class="product-title">
                                                            <img src="{{asset('theme')}}/images/_shop/model2small.jpg" alt="Kallyas Product" title="Kallyas Product" />Natural grej fox fur coat
                                                        </a>
                                                        <span class="color-variations">Grej</span>
                                                        <span class="quantity">1 × <span class="amount">£2,499.00</span></span></li>
                                                </ul>
                                                <!-- end product list -->
                                                <p class="total">
                                                    <strong>Subtotal:</strong><span class="amount">£2,499.00</span>
                                                </p>
                                                <p class="buttons">
            ...
            <div class="row">
                <div class="offset-lg-2 offset-md-2 col-sm-12 col-md-8 col-lg-8">
                    ...
                    <div class="kl-title-block clearfix text-center">
                        <!-- Title with montserrat font, white and bold style -->
                        <h3 class="tbk__title montserrat fw-bold white">
                            STAY TUNED!
                        </h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 d-flex justify-content-start">
                    <div class="d-flex mr-30">
                        <a href="index.html">
                            <img src="{{asset('theme')}}/images/kallyas-footerlogo.svg" width="115" height="37" alt="Kallyas Demo" title="Kallyas Demo" />
                        </a>
                    </div>
...
<div id="newsletter-box" class="kl-pp-box kl-newsletter-box mfp-hide"  data-ppbox-timeout="10000" data-cookie-expire="7">
    <div class="kl-pp-inner">
        <div class="nlbox--preview" style="background-image: url({{asset('theme')}}/images/_niches/fashion/nlpreview2.jpg);">
            <div class="nlbox-logo" style="background-image: url({{asset('theme')}}/images/kallyas-logo.svg)"></div>
            <!-- /.nlbox-logo -->
        </div>
        <div class="nlbox--inner">
            ...
            <div class="fs-xl fs-xs-l reset-line-height mb-30">
                ONLY THIS WEEK. GET BUSY!
            </div>
            <!-- /.fs-xl -->
            <!-- Begin MailChimp Signup Form -->
            <!-- tutorial here: http://designshack.net/articles/css/custom-mailchimp-email-signup-form/ -->
            <div class="newsletter-signup">
                <form action="http://YOUR_USERNAME.DATASERVER.list-manage.com/subscribe/post-json?u=YOUR_API_KEY&amp;id=LIST_ID&c=?" method="post" id="mc-embedded-subscribe-form-pop" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <input type="email" value="" name="EMAIL" class="nl-email form-control" id="mce-EMAIL-pop" placeholder="email@domain.com" required>
...
<script type="text/javascript" src="{{asset('theme')}}/js/kl-plugins.js"></script>



<!-- Required js script for iOS slider -->
<script type="text/javascript" src="{{asset('theme')}}/js/plugins/_sliders/ios/jquery.iosslider.min.js"></script>

<!-- Required js trigger for iOS Slider -->
<script type="text/javascript" src="{{asset('theme')}}/js/trigger/slider/ios/kl-ios-slider.js"></script>

<!-- Slick required js script for Products Carousel elements -->
<script type="text/javascript" src="{{asset('theme')}}/js/plugins/_sliders/slick/slick.js"></script>

<!-- Required js trigger for Products Carousel elements -->
<script type="text/javascript" src="{{asset('theme')}}/js/trigger/kl-slick-slider.js"></script>
...
<script type="text/javascript" src="{{asset('theme')}}/js/plugins/_sliders/revolution-slider/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="{{asset('theme')}}/js/plugins/_sliders/revolution-slider/jquery.themepunch.revolution.min.js"></script>
...
<script type="text/javascript" src="{{asset('theme')}}/js/kl-scripts.js"></script>

<!-- Custom user JS codes -->
<script type="text/javascript" src="{{asset('theme')}}/js/kl-custom.js"></script>
