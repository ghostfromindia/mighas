...
<link href="{{asset('public/assets/plugins/jquery-confirm/jquery-confirm.min.css')}}" rel="stylesheet" type="text/css" media="screen" />
<link href="{{asset('public/assets/plugins/bootstrap-checkbox/css/bootstrap-checkbox.css')}}" rel="stylesheet" type="text/css" media="screen" />
<link href="{{asset('public/assets/plugins/bootstrap-datepicker/css/datepicker.css')}}" rel="stylesheet" type="text/css" media="screen" />
<link href="{{asset('public/assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css')}}" rel="stylesheet" type="text/css" media="screen" />
<link href="{{asset('public/pages/css/themes/coporate.css')}}" rel="stylesheet" type="text/css" media="screen" />