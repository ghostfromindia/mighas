...
@section('content')
    <div class="container-fluid">
        <div class="col-md-12 mb-20"  align="right" style="margin-bottom: 20px; ">
          ...
          <div >
              <div class="btn-group">
                  <a href="{{url('admin/settings')}}" class="btn btn-success"><i class="fa fa-list"></i> List General Settings</a>
              </div>
          </div>
        </div>
        <div class="col-lg-12">
            <div class="card card-borderless">
                {{Form::open(['url' => route('admin.settings.store'), 'method' => 'post','enctype' => 'multipart/form-data', 'id'=>'SettingsFrm'])}}
                        ...
                        <div class="settings-item row">
                            <div class="col-md-3">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label>Type</label>
                                        {!! Form::select('type[]', array('Text'=>'Text', 'Image'=>'Image'), null, array('class'=>'form-control select2_input full-width select2-dropdown input_type', 'id'=>'type_1')); !!}
                            ...
                            <div class="col-md-4">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default required">
                                        <label>Key</label>
                                        {{ Form::text("code[]", null, array('class'=>'form-control', 'id' => 'code_1')) }}
                            ...
                            <div class="col-md-4">
                                <div class="row column-seperation padding-5 text-field">
                                    <div class="form-group form-group-default required">
                                        <label>Value</label>
                                        {{ Form::text("value[]", null, array('class'=>'form-control', 'id' => 'value_1')) }}
