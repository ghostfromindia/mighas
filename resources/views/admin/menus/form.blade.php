                            ...
                            <div class="row column-seperation padding-5">
                                <div class="form-group form-group-default form-group-default-select2">
                                  ...
                                  <select name="position" class="full-width select2_input">
                                    ...
                                    <option value="Main Menu" @if($obj->position == 'Main Menu') selected="selected" @endif>Main Menu</option>
                                  </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row column-seperation padding-5">
                                <div class="form-group form-group-default form-group-default-select2">
                                  ...
                                  <select name="menu_type" class="full-width select2_input">
                                    <option value="0" @if($obj->menu_type == '0') selected="selected" @endif>Normal</option>
                                    <option value="1" @if($obj->menu_type == '1') selected="selected" @endif>Mega Menu</option>
                                  </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row column-seperation padding-5">
                                <div class="form-group form-group-default required">
                                    ...
                                    <input type="number" name="menu_order" class="form-control" value="{{$obj->menu_order}}" >
                                </div>
                            </div>
                        </div>
                              ...
                              <div class="dd">
                                  <ol class="dd-list custom-accordion-menu">
                                    @if($obj->id && $obj->menu_items)
                                      @include('admin.menus.menu', ['items'=>$obj->menu_items])
                                    @endif
                                  </ol>
                              </div>
