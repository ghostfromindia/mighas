        ...
        <div class="container">
            ...
            <div class="card card-borderless padding-15">
                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                           data-datatable-ajax-url="{{ url('admin/offers') }}" >
                        ...
                        <tr>
                            ...
                            <th class="table-width-120">{!! Form::select('type', array(''=>'All', 'Price'=>'Price', 'Combo'=>'Combo', 'Free'=>'Free'), null, array('class'=>'select-box-input select2-dropdown')); !!}</th>
