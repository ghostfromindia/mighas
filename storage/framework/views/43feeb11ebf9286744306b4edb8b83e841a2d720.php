             ...
             <form action="<?php echo e(url('store-locator')); ?>" class="m-0" method="POST">
                       ...
                       <?php if(count($branches)>0): ?>
                               ...
                               <div class="address-card__body">
                                   ...
                                   <?php if($branch->contact_person && $branch->contact_person_number): ?>
                                       <a href="tel:<?php echo e($branch->contact_person_number); ?>"><?php echo e($branch->contact_person.' : '.$branch->contact_person_number); ?></a>
                                   <?php endif; ?>
                                        </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('hykon.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hykon\resources\views/hykon/pages/outlet.blade.php ENDPATH**/ ?>