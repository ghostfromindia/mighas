            ...
            <div class="container">
                ...
                <div class="product-tabs prd-dtl-cntr">
                    <div class="product-tabs__list">
                        ...
                        <?php endif; ?>
                        <?php if(count($attributes)>1 || count($specification)>1): ?>
                    ...
                    <div class="product-tabs__content">
                        ...
                        <?php endif; ?>
                            ...
                            <?php if(count($specification)>1): ?>
                                <div class="product-tabs__pane" id="tab-specification">
                                    <div class="spec">
                                        <h3 class="spec__header">Specification</h3>
                                        <?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="spec__section">
                                                ...
                                                <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="spec__row">
                                                        <div class="spec__name"><?php echo e($obj->key); ?></div>
                                                        <div class="spec__value"><?php echo e($obj->value); ?></div>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('hykon.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hykon\resources\views/hykon/pages/single_product.blade.php ENDPATH**/ ?>