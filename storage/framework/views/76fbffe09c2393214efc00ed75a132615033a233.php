    ...
    <div class="kl-slideshow uh_light_gray kl-revolution-slider">
        ...
        <div class="kl-slideshow iosslider-slideshow uh_light_gray iosslider--custom-height scrollme">
            ...
            <div class="iosSlider kl-slideshow-inner animateme" data-trans="6000" data-autoplay="1" data-infinite="true" data-when="span" data-from="0" data-to="0.75" data-translatey="300" data-easing="linear">
                ...
                <?php $__currentLoopData = $slider->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Slide 3 -->
                        <div class="item iosslider__item <?php if($loop->index ==1): ?>kl-iosslider-active <?php endif; ?>">
                            <!-- Image -->
                            <div class="slide-item-bg" style="background-image: url(<?php echo e(asset('theme')); ?>/images/sliders/old-iosslider-3.jpg);">
                            </div>
                            <!--/ Image -->
                            ...
                            <div class="container kl-iosslide-caption kl-ioscaption--style5 fromleft klios-alignright kl-caption-posv-middle">
                                ...
                                <div class="animateme" data-when="span" data-from="0" data-to="0.75" data-opacity="0.1" data-easing="linear">
                                    ...
                                    <div class="more">
                                        ...
                                        <a href="<?php echo e($obj->button_link); ?>" target="_self" class="btn btn-fullcolor" title="Kallyas Collection">
                                            <?php echo e($obj->button_text); ?>

                                        </a>
                                        <!--/ Button full color style -->

                                        <!-- Button full lined style -->
                                        <a href=" <?php echo e($obj->button2_link); ?>" target="_self" class="btn btn-lined" title="">
                                            <?php echo e($obj->button2_text); ?>
            ...
            <div class="kl-ios-selectors-block bullets2">
                ...
                <?php $__currentLoopData = $slider->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Item #1 -->
                    <div class="item iosslider__bull-item <?php if($loop->index == 0): ?> first selected <?php endif; ?>">
                    </div>
                    <!--/ Item #1 -->
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <section class="hg_section--relative bg-white section-shadow pt-100 pb-100">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="kl-title-block text-center tbk-symbol--icon">
                        ...
                        <h3 class="tbk__title kl-font-alt fs-xl tcolor">
                            <?php echo e(Key::get('hb-banner-title')); ?>
                ...
                <?php echo $__env->make('migas.components.latest_offers1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('migas.components.latest_offers2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('migas._layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\migas\resources\views/migas/pages/home.blade.php ENDPATH**/ ?>