        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-12 col-lg-4  ">
                    ...
                    <b>Date : <?php echo e(Carbon\Carbon::parse($event->event_date_time)->format('d F Y')); ?></b><br>
                    <b>Time : <?php echo e(Carbon\Carbon::parse($event->event_date_time)->format('h:i')); ?></b>
                            ...
                            <?php $__currentLoopData = $upcoming_events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row pe--row justify-content-center align-self-center">
                                    ...
                                    <span class="list-card__date">
                                        <?php echo e(\Carbon\Carbon::parse($obj->event_date_time)->format('d M Y, h:i A')); ?>
...
<?php echo $__env->make('hykon.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/works/public_html/hykon-beta/resources/views/hykon/pages/event_details.blade.php ENDPATH**/ ?>