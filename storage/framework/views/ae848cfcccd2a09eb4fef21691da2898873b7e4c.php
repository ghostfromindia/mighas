                                        ...
                                        <div class="row mt40px">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="block event-teaser">
                                                    ...
                                                    <img src="<?php echo e($obj->featured_image->file_path); ?>" alt="" style="object-fit: contain">
                                                    </div>
                                                            ...
                                                            <div class="hdevt--item">
                                                                <header>
                                                                        <span class="event-teaser__date">
                                                                               <b><?php echo e(Carbon\Carbon::parse($obj->event_date_time)->format('Y')); ?></b><br>
...
<?php echo $__env->make('hykon.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hykon\resources\views/hykon/pages/news.blade.php ENDPATH**/ ?>