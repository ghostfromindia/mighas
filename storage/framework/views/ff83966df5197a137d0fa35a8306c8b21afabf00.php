...
<body>
    <?php if(auth()->guard()->check()): ?> <?php else: ?>
        <?php if(empty(session('common-popup'))): ?>
...
<div class="main-contact-icon-right-sd">
    <div class="call-right quick-contact">
        <a class="slide-left" href="<?php echo e(asset('hykon-ui')); ?>/tel:+000000000"><span>98950 98950 </span></a>
    </div>
    <div class="mail-right quick-contact">
        <a href="mailto:yourmailid" class="slide-left"><span class="span">
            Send a message</span></a>
    </div>
</div>
<!-- quickview-modal -->
...
<?php /**PATH /home/works/public_html/hykon-beta/resources/views/hykon/layouts/base.blade.php ENDPATH**/ ?>