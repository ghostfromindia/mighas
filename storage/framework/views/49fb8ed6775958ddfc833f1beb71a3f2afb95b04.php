                ...
                <div class="tab-content">
                    <div class="tab-pane active show" id="tab1Basic">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label>Type</label>
                                        <?php echo Form::select('type', array('Page'=>'Page', 'Blog'=>'Blog', 'News'=>'News', 'Landing'=>'Landing', 'Events'=>'Events','History'=>'History'), $obj->type, array('class'=>'full-width select2_input', 'id'=>'inputStatus', 'data-placeholder'=>'Choose a type','data-init-plugin'=>'select2',));; ?>
                            ...
                            <div class="col-md-6" <?php if($obj->type != 'Events' && $obj->type != 'History'): ?> style="display: none"  <?php endif; ?>>
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default required">
                                        <label><?php if($obj->type== 'History'): ?> History date <?php else: ?> Event Date and Time <?php endif; ?></label>
                                        <input type="datetime-local" name="event_date_time" class="form-control" value="<?php echo e($obj->event_date_time); ?>" >
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <input type="text" name="block-1-heading" class="form-control" value="<?php echo e($obj->block_1_title); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <textarea name="block-1-summary" class="form-control" rows="3" id="summary"><?php echo e($obj->block_1_summary); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <select name="block-1-products" class="full-width select2_input" data-select2-url="<?php echo e(route('select2.products')); ?>" data-placeholder="Select Products" data-init-plugin="select2" multiple="true"></select>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <input type="text" name="block-2-heading" class="form-control" value="<?php echo e($obj->block_2_title); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <textarea name="block-2-summary" class="form-control" rows="3" id="summary1"><?php echo e($obj->block_2_summary); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <select name="block-2-products" class="full-width select2_input" data-select2-url="<?php echo e(route('select2.products')); ?>" data-placeholder="Select Products" data-init-plugin="select2" multiple="true"></select>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <input type="text" name="block-3-heading" class="form-control" value="<?php echo e($obj->block_3_title); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <textarea name="block-3-summary" class="form-control" rows="3" id="summary3"><?php echo e($obj->block_3_summary); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row column-seperation padding-5">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <select name="block-3-products" class="full-width select2_input" data-select2-url="<?php echo e(route('select2.products')); ?>" data-placeholder="Select Products" data-init-plugin="select2" multiple="true"></select>
    ...
    <script type="text/javascript">
        ...
        $('.block-1-submit').click(function () {
            ...
            var data = {
                ...
                title : title,
                type : 'block-1',
                landing_id : '<?php echo e($obj->id); ?>',
                summary : summary,
                _token : csrf
            }

            $.post('<?php echo e(url('admin/landing-page-blocks')); ?>',data).done(function (data) {
        ...
        function update_block_1(){
            ...
            $.post('<?php echo e(url('admin/landing-page-blocks/get')); ?>',data).done(function (data) {
                data = JSON.parse(data);
                $('#block-1-reponse').html(data.status);
                console.log(data);
        ...
        <script>
            $('.destroy-this').click(function () { alert(1);
                ...
                $.post('<?php echo e(url('admin/landing-page-blocks/destroy')); ?>',data).done(function (data){
                    data = JSON.parse(data);
                    $(this).fadeOut();
                    $('#block-1-reponse').html(data.status);
                })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.common.datatable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/works/public_html/hykon-beta/resources/views/admin/pages/form.blade.php ENDPATH**/ ?>