    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="card card-borderless filter-wrap">
                <form method="POST" action="<?php echo e(route($route.'.store')); ?>" class="p-t-15" id="DealerFrm" data-validate=true>
                  <?php echo csrf_field(); ?>
                <div class="row m-2">
                    <div class="col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.common.datatable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/works/public_html/hykon-beta/resources/views/admin/sliders/index.blade.php ENDPATH**/ ?>