                ...
                <div class="block-brands__slider">
                    <div class="owl-carousel">
                        <?php if($clients->photos): ?>
                            ...
                            <a href=""><img src="<?php echo e(asset($obj->media->file_path)); ?>" alt=""></a>
                        </div>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
    ...
    <script>
        $( document ).ready(function() {
            ...
            function build_temp_brach(slug,name,address,mobile) {
                if(mobile == null){
                    return '<div class="col-12 col-md-6"><a href="'+baseUrl+'/service-points/'+slug+'/"><div class="branch-results"><b>'+name+'</b><p>'+address+'</p></div></a></div>'
                }
                return '<div class="col-12 col-md-6"><a href="'+baseUrl+'/service-points/'+slug+'/"><div class="branch-results"><b>'+name+'</b><p>'+address+'<br>Call '+mobile+'</p></div></a></div>'
            }
            ...
            function fetch_branch(state=null,district=null,brach=null) {
                $.get('<?php echo e(url('branch/list')); ?>?district='+district+'&state='+state+'&dealer='+brach).done(function (data) {
                    ...
                    data.forEach(function (item) {
                        op += build_temp_brach(item.name,item.address,item.mobile);
                    })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('hykon.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/works/public_html/hykon-beta/resources/views/hykon/pages/home.blade.php ENDPATH**/ ?>